...
public class clsDatos {
    ...
    public int insertarVivienda(String codigo_vivienda, int precio, String descripcion, int habitaciones, int metros, int metros_terreno) {
        Object[] parametrosVivienda = {codigo_vivienda, precio, descripcion, habitaciones, metros, metros_terreno};
        return clsViviendaBD.insertVivienda(objConexion, objStatements, objRS, parametrosVivienda);
    }
